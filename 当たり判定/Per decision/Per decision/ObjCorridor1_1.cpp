...
{
	//上壁
	Hits::SetHitBox(this, 0.0f, 70.0f, 352, 110, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 1);

	//上ドア1
	//Hits::SetHitBox(this, 352.0f, 70.0f, 54, 110, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 9);

	//上壁
	Hits::SetHitBox(this, 404.0f, 70.0f, 210, 110, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 1);

	//上ドア2
	Hits::SetHitBox(this, 614.0f, 70.0f, 46, 110, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 1);

	//上壁
	Hits::SetHitBox(this, 660.0f, 70.0f, 30, 110, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 1);

	//上ドア3
	Hits::SetHitBox(this, 690.0f, 70.0f, 43, 110, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 1);

	//上壁
	Hits::SetHitBox(this, 733.0f, 70.0f, 95, 110, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 1);

	//下壁
	Hits::SetHitBox(this, 0.0f, 500.0f, 56, 100, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 1);

	//下ドア1
	//Hits::SetHitBox(this, 56.0f, 600.0f, 50, 1, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 9);

	//下壁
	Hits::SetHitBox(this, 106.0f, 500.0f, 545, 100, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 1);

	//下ドア2
	//Hits::SetHitBox(this, 645.0f, 600.0f, 50, 1, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 9);

	//下壁
	Hits::SetHitBox(this, 699.0f, 500.0f, 100, 100, ELEMENT_CORRIDOR1_1, OBJ_CORRIDOR1_1, 1);
