...
float CObjCorridor1_3::Dot(float ax, float ay, float bx, float by)
{
	float t = 0.0f;
...
//戻り値 float :射影
//内容 AベクトルとBベクトルで内積を行い射影を求める
float CObjCorridor1_3::Cross(float ax, float ay, float bx, float by)
{
	float t = 0.0f;
...
//主人公と壁の交差判定関数
bool CObjCorridor1_3::HeroCorridor1_3CrossPoint(
...
//Corridor1_1Hit関数
void CObjCorridor1_3::Corridor1_3Hit
(
