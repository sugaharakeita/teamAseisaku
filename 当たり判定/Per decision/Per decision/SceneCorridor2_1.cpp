...
//コンストラクタ
CSceneCorridor2_1::CSceneCorridor2_1()
{
...
//初期化メゾット
void CSceneCorridor2_1::InitScene()
{
	//音楽読み込み
	...
	//Corridor2_1オブジェクト生成
	CObjCorridor2_1* objb = new CObjCorridor2_1();
	Objs::InsertObj(objb, OBJ_CORRIDOR2_1, 9);
