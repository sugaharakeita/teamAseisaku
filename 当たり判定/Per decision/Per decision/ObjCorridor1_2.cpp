...
float CObjCorridor1_2::Dot(float ax, float ay, float bx, float by)
{
	float t = 0.0f;
...
//戻り値 float :射影
//内容 AベクトルとBベクトルで内積を行い射影を求める
float CObjCorridor1_2::Cross(float ax, float ay, float bx, float by)
{
	float t = 0.0f;
...
bool CObjCorridor1_2::LineCrossPoint(
...
//主人公と壁の交差判定関数
bool CObjCorridor1_2::HeroCorridor1_2CrossPoint(
...
//Corridor1_2Hit関数
void CObjCorridor1_2::Corridor1_2Hit
(
